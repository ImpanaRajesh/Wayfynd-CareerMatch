# 📄 Wayfynd CareerMatch — AI Job Recommender
...
| AI Inference | [Groq API](https://console.groq.com/) (Llama 3.3 70B Versatile) — via OpenAI-compatible SDK |
| PDF Parsing | [PyMuPDF (fitz)](https://pymupdf.readthedocs.io/) |
| Job Scraping | [Apify](https://apify.com/) (LinkedIn Jobs Scraper + Naukri Jobs Scraper actors) |
| MCP Integration | [FastMCP](https://github.com/modelcontextprotocol) |
...
1. **Upload a resume (PDF)** → text is extracted via `extract_text_from_pdf()`.
2. **AI analysis** (`ask_openai()`, powered by Groq) generates:
   - A resume summary
   - A skill-gap analysis
   - A future career roadmap
3. **Job keyword extraction** — the AI condenses the resume summary into a comma-separated list of job search keywords.
4. **Job fetching**:
...
5. Results are rendered in the Streamlit UI with clickable job links.
